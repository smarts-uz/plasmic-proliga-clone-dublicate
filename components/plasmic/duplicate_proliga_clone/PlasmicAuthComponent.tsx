...
import sty from "./PlasmicAuthComponent.module.css"; // plasmic-import: ZdkRel5xiZQr/css
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__duSbx)}>
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/duplicate_proliga_clone/images/_754FacebookIconjpg.jpg",
            fullWidth: 866,
            fullHeight: 650,
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___8Nuq0, {
          [sty.freeBoxisSignUpFlow___8Nuq09Aua5]: hasVariant(
            $state,
            "isSignUpFlow",
            "isSignUpFlow"
          )
      ...
      {(() => {
        ...
        return (
          ...
          >
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__jueD2)}
              initialValue={undefined}
              label={"phone_number"}
              name={"phone_number"}
            >
            ...
            <FormItemWrapper
              className={classNames("__wab_instance", sty.formField__tPdci)}
              initialValue={undefined}
              label={"name"}
              name={"name"}
            >
      ...
      <div
        className={classNames(
          ...
          sty.text__anTse,
          {
            [sty.textisSignUpFlow__anTse9Aua5]: hasVariant(
              $state,
              "isSignUpFlow",
              "isSignUpFlow"
            )
      ...
      <div className={classNames(projectcss.all, sty.freeBox___54Ebk)}>
        <div
          className={classNames(projectcss.all, sty.freeBox__zglb7)}
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__ceRUe,
              {
                [sty.textisSignUpFlow__ceRUe9Aua5]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                )
          ...
          <div
            className={classNames(
              ...
              sty.text__xl53Q,
              {
                [sty.textisSignUpFlow__xl53Q9Aua5]: hasVariant(
                  $state,
                  "isSignUpFlow",
                  "isSignUpFlow"
                )
          ...
          <div className={classNames(projectcss.all, sty.freeBox__c2Bd6)}>
            <AntdRadio
          ...
          >
            <div
              className={classNames(
                ...
                sty.text__aJvxr,
                {
                  [sty.textisSignUpFlow__aJvxr9Aua5]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__j3J1, {
              [sty.freeBoxisSignUpFlow__j3J19Aua5]: hasVariant(
                $state,
                "isSignUpFlow",
                "isSignUpFlow"
              )
          ...
          >
            <div
              className={classNames(
                ...
                sty.text__h3Q1Q,
                {
                  [sty.textisSignUpFlow__h3Q1Q9Aua5]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
            ...
            <div
              className={classNames(
                ...
                sty.text__gMk0N,
                {
                  [sty.textisSignUpFlow__gMk0N9Aua5]: hasVariant(
                    $state,
                    "isSignUpFlow",
                    "isSignUpFlow"
                  )
