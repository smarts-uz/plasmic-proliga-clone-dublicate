          ...
          <div className={classNames(projectcss.all, sty.column__q4AGo)}>
            <div className={classNames(projectcss.all, sty.freeBox__rXo)}>
              <PlasmicImg__
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/duplicate_proliga_clone/images/xetafepng.png",
                  fullWidth: 96,
                  fullHeight: 104,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__poZu)}>
              <PlasmicImg__
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/duplicate_proliga_clone/images/freeRedHospitalClinicIcon10725Thumbpng.png",
                  fullWidth: 512,
                  fullHeight: 512,
                  aspectRatio: undefined
                }}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__uUwr)}>
              <PlasmicImg__
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/duplicate_proliga_clone/images/freesvgorg59596Png.png",
                  fullWidth: 600,
                  fullHeight: 600,
                  aspectRatio: undefined
                }}
