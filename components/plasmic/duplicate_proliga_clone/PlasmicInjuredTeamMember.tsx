...
import sty from "./PlasmicInjuredTeamMember.module.css"; // plasmic-import: sSfppfkBqSwu/css
  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__teVn2)}
          displayHeight={"auto"}
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__ehyKr)}
          displayHeight={"20px"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/duplicate_proliga_clone/images/crossMedicalCircle512Webp.webp",
            fullWidth: 512,
            fullHeight: 512,
            aspectRatio: undefined
          }}
